...
class ModeSelectScreen(Screen):
    ...
    def on_resize(self, width: int, height: int) -> None:
        center_x = width // 2
        self.canvas.coords(self.title_id, center_x, int(height * 0.09))
        self.canvas.coords(self.subtitle_id, center_x, int(height * 0.17))
        self.canvas.coords(self.buttons_window, center_x, int(height * 0.32))
        self.canvas.itemconfigure(self.buttons_window, width=int(width * 0.36))
